...
export default function LoginDesignView({ isDarkMode }) {
  ...
  const [portalFilter, setPortalFilter] = useState('all'); // 'all' | 'super_admin' | 'admin' | 'active_only'
  ...
  // Handle Image File Selection (Local Gallery or Camera)
      ...
      >
        <div className="space-y-1">
          ...
          <p className={`text-xs ${isDarkMode ? 'text-slate-400' : 'text-slate-500'}`}>
            Manage, upload, and publish pictures and titles for the split-screen login page in SuperAdmin and Admin.
          </p>
        </div>
            ...
            <form onSubmit={handleSaveDesign} className="p-6 overflow-y-auto space-y-5 flex-1">
              ...
              <div className="space-y-2">
                ...
                <div className="relative h-44 rounded-xl overflow-hidden border border-slate-300 dark:border-slate-700 bg-slate-950 flex items-center justify-center group">
                  ...
                  {/* Upload Actions floating over preview */}
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  placeholder="e.g. Executive Administration or Highest Security Level Required"
              ...
              <div className="space-y-1.5">
                <label className="block text-xs font-bold uppercase tracking-wider text-slate-400">
                  Hero Title (Displayed Bold on Left Panel)
                </label>
                <input
                  type="text"
